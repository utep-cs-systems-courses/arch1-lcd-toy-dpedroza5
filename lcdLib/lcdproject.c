...
main()
{
  ...
  while (1) {			/* forever */
    if (redrawScreen) {
      redrawScreen = 0;
      drawString11x16(5,stringRow, "My Project", COLOR_BLACK, COLOR_BLACK);
      drawString11x16(5,nextStringRow, "My Project", fontFgColor, COLOR_BLACK);
